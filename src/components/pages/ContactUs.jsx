    ...
    <React.Fragment>
      <section className="content-container">
        <div className="textArea">
          ...
          <p>
            If you think we could work together one something cool, I'd love to
            hear from you
            <br />
            For any enquiries, feel free to drop me an email!
          </p>
        </div>
          ...
          <div className="row">
            <div className="col-left">
              <form id="contact" action="">
                <h4 className="leave-us-a-message">Leave us a message</h4>
                <fieldset>
                  <input
